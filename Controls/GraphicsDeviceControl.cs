...
namespace AOUIEditor
{
    public abstract class GraphicsDeviceControl : Control
    {
        ...
        /// </summary>
        private SwapChainRenderTarget chain;
        ...
        protected override void OnCreateControl()
        {
            ...
            if (!DesignMode)
            {
                ...
                chain = new SwapChainRenderTarget(graphicsDeviceService.GraphicsDevice, Handle, ClientSize.Width, ClientSize.Height);
        ...
        string BeginDraw()
        {
            ...
            graphicsDeviceService.GraphicsDevice.SetRenderTarget(chain);
        ...
        private void RefreshDXWindow()
        {
            ...
            {
                chain.Dispose();
                chain = new SwapChainRenderTarget(graphicsDeviceService.GraphicsDevice, Handle, ClientSize.Width,
                        ClientSize.Height);

                GraphicsDevice.PresentationParameters.BackBufferWidth = ClientSize.Width;
                GraphicsDevice.PresentationParameters.BackBufferHeight = ClientSize.Height;

                //SwapChainRenderTargetRefreshed?.Invoke(chain);
            }
        }
    }
}
